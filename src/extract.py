...
class Extract:
    ...
    def extract_ibge_Hackathon(self):

        url = "https://servicodados.ibge.gov.br/api/v3/agregados/4093/periodos/-50/variaveis/4096%7C4099%7C12466?localidades=N1[all]|N3[all]&classificacao=2[all]"
